...
<div class="wrap">
    ...
    <a href="https://github.com/ThemesEmail/woocommerce-email-testing" target="_blank" class="page-title-action" onclick="ga('send', 'event', 'WooCommerce Email Testing', 'WET', 'Learn More');">Learn More</a>
